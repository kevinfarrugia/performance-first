    ...
    rules: [
      {
        ...
        generator: {
          ...
          emit: false, // fonts are generated by the server config
        },
      },
      {
        exclude: [
...
const clientConfig = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      filename: path.resolve(OUTPUT_DIR, "index.hbs"),
      showErrors: isDevelopment,
      template: path.resolve(SRC_DIR, "templates", "index.hbs"),
      inject: false,
    }),
    new HtmlWebpackPlugin({
      filename: path.resolve(OUTPUT_DIR, "500.hbs"),
      showErrors: isDevelopment,
            ...
            oneOf: [
              {
                ...
                generator: {
                  filename: staticAssetName,
                  dataUrl: (content) => svgToMiniDataURI(content.toString()),
                  emit: false, // static assets are generated by the client config
                },
                parser: {
                  dataUrlCondition: {
                    maxSize: 4 * 1024, // 4kb
